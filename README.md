...
in ye olden times, Node didn't much support promises nor the `fetch` stuff, so Deno was much more up-to-date in that regard. Node does do it as well now, though the lack of top-level awaits is unfortunate.

Deno first came out all the way back in March 2018, [around the time i began messing with code](https://gist.github.com/corn-snake/240402561bade0c22f68ee0aaf962dff/revisions) (...not sure that it ever did work, the class names are wrong lmao...... _anyway_). Deno was leagues more friendly to a beginner than Node, particularly relating to actual ECMAScript conventions that Node just didn't (and still doesn't, see WebCrypto) have — i was a fairly early adopter of it as a result, as much as a kid with too much time and too little purpose in life could've been such
