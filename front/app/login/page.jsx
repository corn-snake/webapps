...
const LogIn = ()=>{
    ...
    return <form className="login_form">
        ...
        <span className="fakeSubmit" onClick={()=>axios.post("http://localhost:80/api/login", {nombre: document.getElementById("usr_login").value, pwHash: sha512(document.getElementById("pw_login").value)}).then(d=>sLi(d.data))}>Log In</span>
    </form>
};
