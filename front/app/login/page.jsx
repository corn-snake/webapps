...
const LogIn = ()=>{
    ...
    return <form className="login_form">
        ...
        <span className="fakeSubmit" onClick={()=>axios.post("http://localhost:8080/api/login", {uname: document.getElementById("usr_login").value, pw: sha512(document.getElementById("pw_login").value)}).then(d=>sLi(d.data))}>Log In</span>
    </form>
};
