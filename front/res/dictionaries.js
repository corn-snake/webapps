...
const dictionary = {
    ...
    schema = [
        {id: "_id", alias: "ID"},
        { id: "nombre", alias: "Usuario" },
        { id: "descripcion", alias: "Nombre" },
        { id: "telefono" },
        {
            id: "direccion", children: [
                { id: "calle" },
                { id: "num", alias: "Número" },
                { id: "cd", alias: "Ciudad" },
                { id: "cp", alias: "Código Postal" }
            ]
        },
        { id: "status", restrict: ["user", "admin"] },
        { id: "pwd", alias: "contraseña"},
    ],
    userSchema = [
        { id: "nombre", alias: "Usuario" },
        { id: "descripcion", alias: "Nombre" },
...
export {dictionary, schema, userSchema, labels, order, modOrder, productNumber, userNumber, modLabels, modFuncs, autocompletable, hide, sources, dont};